...
public class CustomDES {
    ...
    public static void main(String[] args) throws IOException {
        String origin="test code, please note";
        ...
        String test = encoder.encode(c);
        System.out.println("加密后的测试文本：\n" + test);
        byte[] secret = decoder.decodeBuffer(test);

        System.out.println("密文：\n"+new String(c));
//        byte[]p=customDES.deal(c,0);
        byte[]p=customDES.deal(secret,0);
